...
.g-entry .btn-skip{border:none;background:transparent;color:var(--g-tx3);font:400 13px/1 'Inter',system-ui,sans-serif;cursor:pointer;padding:15px 24px;margin-top:10px}
