...
.g-entry .qa{position:relative;z-index:1;display:flex;flex:1 0 auto;flex-direction:column;animation:si .3s var(--ease)}
...
.g-entry .btn-skip{border:none;background:transparent;color:var(--g-tx3);font:400 13px/1 'Inter',system-ui,sans-serif;cursor:pointer;padding:14px 24px;margin-top:-6px}
...
.g-review .qa{display:flex;flex:1 0 auto;flex-direction:column;animation:si .3s var(--ease)}
...
.scr.g-srm-picker{height:100dvh;overflow-y:auto;overscroll-behavior:none;-webkit-overflow-scrolling:touch}
...
.g-srm-single{display:flex;height:100dvh;flex-direction:column;overflow-y:auto;overscroll-behavior:none;-webkit-overflow-scrolling:touch}
...
.g-confirm{display:flex;align-items:center;justify-content:center;height:100dvh;overflow-y:auto;overscroll-behavior:none;-webkit-overflow-scrolling:touch}
...
.g-entry .btn-skip{margin-bottom:4px}
